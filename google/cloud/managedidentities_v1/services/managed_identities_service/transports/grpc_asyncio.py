...
class ManagedIdentitiesServiceGrpcAsyncIOTransport(ManagedIdentitiesServiceTransport):
    ...
    def attach_trust(
        ...
        [managed_identities_service.AttachTrustRequest], Awaitable[operations.Operation]
    ]:
    ...
    def detach_trust(
        ...
        [managed_identities_service.DetachTrustRequest], Awaitable[operations.Operation]
    ]:
