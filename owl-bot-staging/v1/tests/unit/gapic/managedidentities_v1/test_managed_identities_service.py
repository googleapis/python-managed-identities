...
from google.cloud.managedidentities_v1.services.managed_identities_service.transports.base import _API_CORE_VERSION
from google.cloud.managedidentities_v1.services.managed_identities_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_managed_identities_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.managedidentities_v1.services.managed_identities_service.transports.ManagedIdentitiesServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_managed_identities_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.managedidentities_v1.services.managed_identities_service.transports.ManagedIdentitiesServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ManagedIdentitiesServiceTransport()
        adc.assert_called_once()
