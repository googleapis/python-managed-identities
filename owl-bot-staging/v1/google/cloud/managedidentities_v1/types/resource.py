...
class Domain(proto.Message):
    ...
    trusts = proto.RepeatedField(proto.MESSAGE, number=15,
        message='Trust',
    )
...
class Trust(proto.Message):
    ...
    trust_type = proto.Field(proto.ENUM, number=2,
        enum=TrustType,
    )

    trust_direction = proto.Field(proto.ENUM, number=3,
        enum=TrustDirection,
    )
    ...
    last_trust_heartbeat_time = proto.Field(proto.MESSAGE, number=12,
        message=timestamp.Timestamp,
    )
